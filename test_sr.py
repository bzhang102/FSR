...
parser.add_argument('--dxdy', default=0, type=int)
...
class Classifier(BaseModelDNN):
    def __init__(self) -> None:
        ...
        if args.model=='resnet18_nofsr_sr_single':
...
def main():
    ...
    for attack_class, attack_kwargs, name in lst_attack:
        ...
        message, defense_success, natural_success = defense_success_rate(model.predict, model.predict_single_pass,
